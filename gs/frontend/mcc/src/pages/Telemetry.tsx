    ...
    <div>
        ...
        >
            ...
            <div className="overflow-y-auto flex-1">
                ...
                <thead className="sticky inset-0 w-full bg-black">
                    ...
                    <td className="flex flex-row justify-between pl-2 w-1/4">
                        ...
                        .filter(header => ["timestamp", "type"].includes(header.id))
                        .map(header => (
                            <th key={header.id} className="font-normal text-center">
                    ...
                    {table.getFlatHeaders()
                        ...
                        .map(header => (
                        <th key={header.id} className="flex-1 font-normal">
                            {flexRender(header.column.columnDef.header, header.getContext())}
                        </th>
                        ))}
                    </tr>
                ...
                <tbody>
                    ...
                    <tr key={row.id} className="flex flex-row gap-2">
                        ...
                        <td className="flex flex-row justify-between pl-2 w-1/4">
                        {row.getVisibleCells()
                            .filter(cell => ["timestamp", "type"].includes(cell.column.id))
                            .map(cell => (
                            <span key={cell.id}>
